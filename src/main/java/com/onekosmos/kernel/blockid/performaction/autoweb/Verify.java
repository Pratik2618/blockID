...
import com.onekosmos.kernel.blockid.framework.exception.ListSizeNotMatchingException;
...
public class Verify {
    ...
    public void elementTextIsEqualTo(String elementName, String textToVerify) {
        ...
        logs.testStep("Get element Text is"+element.find(elementName).getText());
        assertThat(element.find(elementName).getText()).isEqualTo(textToVerify);
        logs.testResult(true);
    }
